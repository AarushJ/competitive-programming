...
int main(){
    ...
    while(t--){
    	...
    	ll ans = -1;	// taken as reference ; beware , no element of array should be -1;
    	
    	// sorting the array arr[0....n-1]
		sort(arr,arr+n); 
    	
    	// printing the array arr[0.....n-1]
    	lp(i,0,n-1)	cout << arr[i] << " "; 
		cout << "\n";
