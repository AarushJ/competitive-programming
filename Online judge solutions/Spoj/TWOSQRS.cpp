/*
	Fermat's sum of squares theorem has been used
	
	Theorem :- A number can be expressed as a sum of 2 squares if all of its prime factors which are of the form 4n+3 can occur even number of times in its 
			   prime factorization.
